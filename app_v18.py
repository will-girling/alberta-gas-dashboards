...
with system_col:
    ...
    if selected_interconnect:
        ...
        if not selected_border_rows.empty:
            ...
            st.markdown(
                ...
                ">
                    <div style="font-size:1.25rem;font-weight:760;">
                        {selected_border["current_abs_mmcf"]:,.0f} MMcf/d
                    </div>
            ...
            st.caption(
                "Current, prorated, nominated and rolling averages use absolute flow "
                "magnitude. vs-average rows retain their sign."
            )
