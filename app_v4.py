...
if show_ngtl_pipelines and ngtl_pipeline_geojson:
    pipe_lons, pipe_lats = pipeline_coordinates(ngtl_pipeline_geojson)
...
with map_col:
    ...
    st.caption(
        "Border-marker positions remain approximate. Pipeline geometry comes "
        "from the processed AER operating-gas layer for NOVA Gas Transmission Ltd."
    )
